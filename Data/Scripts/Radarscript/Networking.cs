...
namespace Cheetah.Networking
{
    ...
    public static class Networker
    {
        ...
        public const ushort CommChannel = 7284;
        ...
        {
            if (Debug) MyAPIGateway.Utilities.ShowMessage(Prefix + Source, Message);
        }

        static void Report(Exception Scrap, string Source, string Prefix = "Networker.")
        {
            MyAPIGateway.Utilities.ShowMessage(Prefix + Source, $"Exception caught: {Scrap.Message}");
        }
    }
